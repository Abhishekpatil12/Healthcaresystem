...
def GButton_907_command():
        ...
        information = mydb.Doctor

        ide = GLineEdit_344.get()
        name = GLineEdit_878.get()
        specialization = GLineEdit_442.get()
        city = GLineEdit_765.get()
        phone = GLineEdit_481.get()
        email = GLineEdit_219.get()
        experience = GLineEdit_377.get()
        hospital = GLineEdit_999.get()
...
if flag==1:
        ...
        GLineEdit_344["bg"] = "#181717"
        GLineEdit_344["borderwidth"] = "1px"
        ft = tkFont.Font(family='Times',size=14)
        GLineEdit_344["font"] = ft
        GLineEdit_344["fg"] = "#1e90ff"
        GLineEdit_344["justify"] = "center"
        GLineEdit_344["text"] = ""
        GLineEdit_344.place(x=290,y=10,width=250,height=30)
